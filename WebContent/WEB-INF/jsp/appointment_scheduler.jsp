		...
		<div class="panel panel-default">
			...
			<div class="formcontainer">	        
				<form:form method="POST"
					action="/CindysResumeApptScheduler/appointment_confirmation"
					modelAttribute="appointment">
					<div class="row">
						<label class="col-md-2 control-lable" for="sync_submit">Synchronous
							Submission</label>
					</div>
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<form:input type="time" path="time"
									class="time form-control input-sm" />
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<form:input type="text" path="comments"
									class="comments form-control input-sm" />
							</div>
						</div>
					</div>
					<div class="row">
